...
This is the complete app of the tutorial I wrote on medium ["A modular approact to routing :React Router 4"](https://medium.com/iqube-bits/a-modular-approach-to-routing-with-react-router-4-d4a3db9f56ae)
